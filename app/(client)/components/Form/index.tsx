"use client"
import { BackgroundImage, Button, Checkbox, Paper, Stack, Text, Textarea, TextInput, Title, Group, Alert } from '@mantine/core'
...
const FormComponent = () => {
    ...
    return (
        <BackgroundImage src='/formBg.jpeg' pos={'absolute'} bottom={'-50px'} h={'550px'} radius={'lg'}>
            <Paper p={'lg'} radius={'lg'} w={'100%'} h={'100%'} bg={'#EFEFEF'} opacity={1} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                <Stack w={'90%'} h={'80%'}>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <Stack>
                            ...
                            <Checkbox
                                ...
                                label={<Text size='xs'>By clicking the checkbox you agree to the Privacy Policy and terms of service</Text>}
                                disabled={isSubmitting}
